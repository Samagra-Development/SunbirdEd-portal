...
let envVariables = {
  ...
  DEVICE_REGISTER_API: process.env.sunbird_device_register_api || 'https://dev.sunbirded.org/api/v3/device/register/',
  DEVICE_PROFILE_API: process.env.sunbird_device_profile_api || 'https://dev.sunbirded.org/api/v3/device/profile/',
